...
import org.sinou.android.kotlin.openapi.model.ActivityObjectType
...
data class ActivityObject (
    ...
    @Json(name = "closed")
    val closed: kotlinx.datetime.Instant? = null,
    ...
    @Json(name = "deleted")
    val deleted: kotlinx.datetime.Instant? = null,

    @Json(name = "duration")
    val duration: kotlinx.datetime.Instant? = null,
    ...
    @Json(name = "published")
    val published: kotlinx.datetime.Instant? = null,
